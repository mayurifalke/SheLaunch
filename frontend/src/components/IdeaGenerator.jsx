  ...
  return (
    <Container className="py-5 mb-4">
      ...
      <Row className="text-center mb-2">
        <Col>
          <div className="d-flex justify-content-center align-items-center gap-4">
            <div>
              <h2 style={{ fontWeight: "bold", color: "#a754e6" }}>
                AI-Powered Idea Generator
              </h2>
              <p className="text-muted">
                Get personalized startup ideas tailored to your education,
                skills, budget, and location.
              </p>
            </div>
            <div>
              <img
          ...
          <Card className="p-4 shadow">
            <Form>
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  type="text"
                  placeholder="e.g. B.E., M.E, MBA, etc"
                  value={education}
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  type="text"
                  placeholder="e.g. sewing, teaching, coding"
                  value={skills}
              ...
              <Form.Group className="mb-3">
                <Form.Label>
                  <strong>Investment Budget (INR)</strong>
                </Form.Label>
                <Form.Control
                  type="number"
              ...
              <Button
                ...
                disabled={loading}
                style={{ backgroundColor: "#a754e6", border: "none" }}
              >
                {loading ? (
                  <>
                    <Spinner
      ...
      >
        <Modal.Header
          closeButton
          style={{ backgroundColor: "#a754e6", color: "white" }}
        >
          <Modal.Title>
            <FcIdea />
