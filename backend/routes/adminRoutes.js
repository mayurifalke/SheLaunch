...
router.put("/verify-entrepreneur/:id", isAdminLoggedIn, adminController.verifyEntrepreneur);

// api to approve investor
router.put("/verify-investor/:id", isAdminLoggedIn, adminController.verifyInvestor);
