...
router.get(
  ...
  isAdminLoggedIn,
  adminController.getPendingEntrepreneurs
);
...
router.get(
  "/pending-investors",
  isAdminLoggedIn,
  adminController.getPendingInvestors
);
...
router.get(
  "/entrepreneur/:id",
  isAdminLoggedIn,
  adminController.getEntrepreneurById
);

// api to approve entrepreneur
router.put(
  "/verify-entrepreneur/:id",
  isAdminLoggedIn,
  authorizeRole("admin"),
  adminController.verifyEntrepreneur
);
...
router.put(
  ...
  isAdminLoggedIn,
  authorizeRole("admin"),
  adminController.verifyInvestor
);
...
router.get(
  "/browse-pitches",
  isAdminLoggedIn,
  adminController.getAllEntrepreneurPitches
);
...
router.delete(
  ...
  isAdminLoggedIn,
  authorizeRole("admin"),
  adminController.deleteInvestor
);
